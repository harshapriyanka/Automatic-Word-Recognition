...
if __name__ == "__main__":
    ...
    noisefiles = ["Processed_Dataset/_background_noise_/doing_the_dishes.wav", 
                    "Processed_Dataset/_background_noise_/dude_miaowing.wav", 
                    "Processed_Dataset/_background_noise_/exercise_bike.wav", 
                    "Processed_Dataset/_background_noise_/pink_noise.wav", 
                    "Processed_Dataset/_background_noise_/running_tap.wav", 
                    "Processed_Dataset/_background_noise_/white_noise.wav"]
    train_location = "Processed_Dataset/train/"
    train_noise_location = "Processed_Dataset/train_noisy/"

    for f in os.listdir(train_location):
        print(f)
        for w in os.listdir(train_location + f):
        	random_noise = np.random.randint(len(noisefiles))
